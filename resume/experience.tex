...
\begin{cventries}
    \cventry
    {Chief Systems Engineer} % Job title
    {DASH Tech Integrated Circuits} % Organization
    ...
    \cventry
    {Graduate Research Assitant} % Job title
    {Center for Wireless Information Systems and Computation Architectures} % Organization
    {Arizona State University, Tempe, Arizona} % Location
    {Oct 2019 - Apr 2023} % Date(s)
    {
        \begin{cvitems} % Description(s) of tasks/responsibilities
