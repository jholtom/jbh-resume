...
\begin{cventries}
    ...
    {Apr 2019 - PRESENT} % Date(s)
    {
        ...
        \item {Explore and develop combined radar and communications wavforms}
        \item {Develop machine learning models for SIGINT}
        \item {Develop dirction finding algorithsm for co-operate use on Software Defined Radar}
        \end{cvitems}
    }
    \cventry
